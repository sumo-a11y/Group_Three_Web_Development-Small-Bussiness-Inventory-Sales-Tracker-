        ...
        <div class="mx-10 max-w-450 space-y-6">
          ...
          <section class="grid grid-cols-1 xl:grid-cols-3 gap-4">
            <div class="xl:col-span-2">
              <SalesChart
                title="Statistics"
                subtitle="Sales & stock movement (select range)"
              />
            </div>
            ...
            <div class="card p-0 overflow-hidden relative">
              ...
              <div
                class="relative p-6 bg-linear-to-br from-orange-500 to-orange-700 text-white"
              >
                <div class="flex items-center justify-between">
                  <div>
                ...
                <button
                  class="mt-5 w-full bg-white text-orange-700 font-semibold py-2.5 rounded-xl hover:bg-orange-50 transition"
                >
                  Check Low Stock
                </button>
              </div>
          ...
          <section class="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <div>
              <LowStockChartBar
                :breakdown="{ critical: 5, warning: 4, healthy: 10 }"
                :totalLowStock="kpis.lowStock"
              />
            </div>
          </section>
